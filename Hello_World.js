...
intent('What is Learnease and who is it designed for?', p => {
    p.play('Learnease is an online learning platform specifically designed to cater to students with disabilities. Our courses are accessible and inclusive, ensuring that everyone can benefit from quality education.');
});
intent('What types of disabilities does your platform accommodate?', p => {
     p.play('We accommodate blindness,deafness,autism and ADHD.');
});
    intent('How is your content made accessible to students with visual impairments?', p => {
    p.play('We provide alternative text descriptions for images, use screen-reader-friendly formats, and ensure compatibility with assistive technologies to make our content accessible to students with visual impairments.');
});
intent('Are subtitles or transcripts available for video content?', p => {
    p.play('Yes, all video content on our platform is accompanied by subtitles or transcripts to assist students with hearing impairments.');
});
intent('What assistive technologies are compatible with your platform?', p => {
    p.play('Our platform is designed to be compatible with a variety of assistive technologies, including screen readers, speech recognition software, and alternative input devices.');
});
intent('How do you support students with motor disabilities?', p => {
    p.play('Our platform offers customizable navigation options and supports various input methods to accommodate students with motor disabilities. Additionally, we provide technical assistance to help customize the learning experience.');
});
intent('Is technical support available for users with disabilities?', p => {
    p.play('Yes, our technical support team is trained to assist users with disabilities. If you encounter any accessibility issues or require assistance, please reach out to our support team.');
});
intent('Are there specific features for students with dyslexia or other learning disabilities?', p => {
    p.play('Yes, we have features such as customizable fonts, background colors, and text spacing to accommodate students with dyslexia or other learning disabilities. Additionally, we offer alternative formats for course materials.');
});
intent('Can I request additional accommodations for my specific needs?', p => {
    p.play('Absolutely. We understand that every student is unique, and we are committed to providing personalized accommodations. Please contact our support team to discuss your specific needs');
});
intent('How do you ensure the privacy and security of student information?', p => {
    p.play('We take the privacy and security of student information seriously. Our platform complies with industry standards for data protection, and we have robust security measures in place to safeguard user data.');
});
